...
inferring an answer from the documentation's silence (`docs/rfcs/0001-container-
rowid-manifest.md` Open questions, item 3; the empirical MinIO result is recorded
directly in `crates/strand-core/tests/s3_store.rs`'s
