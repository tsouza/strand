...
/// exact value, is not optional. `pub` so `bench/src/reader_refresh_
/// contention.rs` (the M0 crash-test data RFC 0001 §3 calls for) and any
/// caller that wants to reason about the bound can reference the real
