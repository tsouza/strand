...
- **Pending figures:** the ~250ms p90 tail figure — re-locate the source sentence or
  ...
  codec-SPI absence — resolved, R11(a) above; FAISS FastScan external-list
  feasibility (R11(b)); the Quickwit inheritance hypothesis (R11(c)). The M0
  vendoring deliverable is partially done — `references/` holds the R2 and
  RFC-0002 grounding, all four turbopuffer
